function Ide3Logic(z, e, t) {
    ...
    r("create_folder", "click", U); oa("tree", "expand", Qb); oa("tree", "click", function () {
        ...
        f.clipboard = new e.Clipboard; e.initControls(f.wide, f.isTryMe); var c; b = x(); f.wide && !f.isTryMe && (a = b.createLeftButton(Ab, "right", "#E2EDF5"), c = b.createRightButton(Bb, "left", "#E2EDF5"), f.openLeftIndex = a, f.openRightIndex = c, b.hideLeftButton(f.openLeftIndex), b.hideRightButton(f.openRightIndex)); Eb(); e.widgets.foreach(Lc); e.widgets.foreach(Mc); a = Jc(); b = { onData: e.onInitCompleted, onError: y };  if (2 <= a.length) {
